...
<?php $__env->startSection('page_title', 'Edit Master Bucket'); ?>
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="white-box">
            ...
            <form class="form-material form-horizontal m-t-30" action="<?php echo e(url('/edit-master-bucket').DIRECTORY_SEPARATOR.$currentBucketDetails['id']); ?>" method="post">
                ...
                <div class="col-md-12">
                    <select name="bucket_region" id="bucket_region" class="form-control" required="">
                      ...
                      <?php $__currentLoopData = $bucketRegions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $regions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <option value="<?php echo e($regions->region_value); ?>" <?php echo e($selected); ?>><?php echo e($regions->region_name); ?></option>
                ...
                <div class="col-md-12">
                  <select name="bucket_short_code" id="bucket_short_code" class="form-control" required="">
                    ...
                    <?php $__currentLoopData = $bucketShortCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shortCode): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <option value="<?php echo e($shortCode->shortcode_value); ?>" <?php echo e($selected); ?>><?php echo e($shortCode->shortcode_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                  <span></span>
                </div>
                ...
                <div class="col-md-12">
                  <select name="bucket_browser" id="bucket_browser" class="form-control" required="">
                    ...
                    <?php $__currentLoopData = $bucketBrowsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $browser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <option value="<?php echo e($browser->browser_value); ?>" <?php echo e($selected); ?>><?php echo e($browser->browser_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                  <span></span>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" id="example-text" name="bucket_phone_number" class="form-control" value="<?php echo e($currentBucketDetails['bucket_phone_number']); ?>" placeholder="Phone Number" required="">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <input type="text" id="example-text" name="bucket_pid" class="form-control" value="<?php echo e($currentBucketDetails['bucket_pid']); ?>" placeholder="PID" required="">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                    <input type="text" id="example-text" name="bucket_analytics_id" class="form-control" value="<?php echo e($currentBucketDetails['bucket_analytics_id']); ?>" placeholder="Analytics ID" required="">
                </div>
              </div>
              <div class="form-group">
                 <label class="col-md-12" for="example-text">Ringba Code</label>
                 <div class="col-md-12">
                      <input type="text" id="example-text" name="ringba_code" class="form-control" value="<?php echo e($currentBucketDetails['ringba_code']); ?>" placeholder="Ringba Code">
                  </div>
              </div>
              <!---BUCKET TEMPLATES-->
              <div class="form-group">
                ...
                <div class="col-md-12">
                  <select name="bucket_template" id="bucket_template" class="form-control" required="">
                    ...
                    <?php $__currentLoopData = $bucketTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      ...
                      <option value="<?php echo e($template->id); ?>" <?php echo e($selected); ?>><?php echo e($template->template_name); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </select>
                  <span></span>
                </div>
