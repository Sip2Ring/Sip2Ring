...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="white-box">
                <h3 class="box-title">Basic Information <?php echo e($bucketParams->bucket_region); ?></h3>
                <form class="form-material form-horizontal m-t-30" action="<?php echo e(url('/edit-bucket-params').DIRECTORY_SEPARATOR.$bucketParams['id']); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <textarea class="form-control" rows="3" name="bucket_parameters"><?php echo e($bucketParams->bucket_parameters); ?></textarea>
                        </div>
                    </div>
